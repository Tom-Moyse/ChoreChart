<?php
// Template navbar for the chore, account and group pages for a moderator - takes a $active variable
    ...
    case 3:
        echo '<nav>
            ...
            <ul>
                <li><a href="chores.php">Group Chores</a></li>
                <li><a href="mychores.php">My Chores</a></li>
                <li><a href="" id="active">Manage Group</a></li>
                <li><a href="managechores.php">Manage Chores</a></li>
                <li><a href="account.php">My Account</a></li>
                <li><a href="php/signout.php">Sign-out</a></li>   
            </ul>
    ...
    case 4:
        echo '<nav>
            ...
            <ul>
                ...
                <li><a href="mychores.php">My Chores</a></li>
                <li><a href="managegroup.php">Manage Group</a></li>
                <li><a href="" id="active">Manage Chores</a></li>
                <li><a href="account.php">My Account</a></li>
                <li><a href="php/signout.php">Sign-out</a></li>
            </ul>
        </nav>';
